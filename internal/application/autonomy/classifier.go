...
func ClassifyFailure(err error) FailureClassification {
	...
	case containsAny(lower, "no such host", "dial tcp", "connection refused", "connection reset", "network is unreachable", "tls handshake", "fetch failed", "timeout awaiting", "temporary failure"):
	...
	default:
		return FailureClassification{Class: FailureClassUnknown, Recoverable: false, Reason: "unclassified"}
	}
}
